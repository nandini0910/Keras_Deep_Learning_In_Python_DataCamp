...
Each hidden layer has two nodes. The input data has been preloaded as input_data.
...
Calculate node_1_0_input using its weights weights['node_1_0']
and the outputs from the first hidden layer - hidden_0_outputs. Then apply the relu() function to get node_1_0_output.
